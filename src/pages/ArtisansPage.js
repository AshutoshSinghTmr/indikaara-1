      ...
      <header className="bg-[#8C0000] text-white py-8 sm:py-12 px-4 sm:px-6">
        ...
        <div className="container mx-auto text-center max-w-6xl">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">
            The Artisans of Indikaara
          </h1>
          <p className="text-sm sm:text-lg opacity-90">
            Celebrating the heart and soul behind every creation.
          </p>
        </div>
      </header>
          ...
          {artisans.map((artisan) => (
            ...
            >
              ...
              <div className="p-3 sm:p-6">
                ...
                <p className="text-gray-300 leading-relaxed mb-3 sm:mb-6 text-xs sm:text-sm line-clamp-3">
                  {artisan.story}
                </p>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="lg:col-span-2">
                  <h3 className="text-lg sm:text-xl font-semibold text-teal-400 mb-4">
                    The Complete Story
                  </h3>
                  <div className="prose prose-gray max-w-none">
                    {selectedArtisan.fullDescription
                      .split("\n\n")
                      .map((paragraph, index) => (
                        <p
                          key={index}
                          className="text-gray-300 leading-relaxed mb-4 text-xs sm:text-sm"
                        >
                          {paragraph}
                        </p>
                      ))}
