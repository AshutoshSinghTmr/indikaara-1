...
const DashboardPage = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 via-white to-purple-50">
        <div className="text-center">
          <div className="relative">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-teal-200 border-t-teal-600 mx-auto mb-6"></div>
            <div
              className="absolute inset-0 rounded-full border-4 border-transparent border-t-purple-600 animate-spin mx-auto"
              style={{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-purple-50 py-8 px-4 sm:px-6 lg:px-8 mt-20">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden mb-10 border border-white/20">
          <div className="bg-gradient-to-r from-teal-600 via-purple-600 to-indigo-600 px-8 py-10 relative overflow-hidden">
            ...
            <div className="relative flex items-center space-x-6">
              ...
              <div className="flex-1 text-white">
                ...
                <p className="text-teal-100 text-lg font-medium">
                  {user.email_verified
                    ? "✓ Verified Account • Member since " +
                      new Date(user.iat * 1000).getFullYear()
                    : "Account Details"}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-lg shadow-xl rounded-2xl overflow-hidden border border-white/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            <div className="px-8 py-6 bg-gradient-to-r from-teal-500/10 to-purple-500/10 border-b border-gray-100/50">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-r from-teal-500 to-purple-500 rounded-xl flex items-center justify-center">
                  <svg
            ...
            <div className="px-8 py-8 space-y-6">
              <div className="group">
                ...
                <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">
              ...
              <div className="group">
                ...
                <p className="text-lg text-gray-900 font-medium flex items-center group-hover:text-teal-600 transition-colors duration-200">
                  {user.email}
                  {user.email_verified && (
                    <svg
                      className="ml-3 h-6 w-6 text-teal-500 animate-pulse"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
              ...
              {user.sub && (
                <div className="group">
                  ...
                  <p className="text-sm text-gray-500 font-mono break-all bg-gray-50 p-3 rounded-lg group-hover:bg-gray-100 transition-colors duration-200">
                    {user.sub}
                  </p>
                </div>
              )}
            ...
            <div className="px-8 py-8 space-y-6">
              <div className="group">
                ...
                <div className="flex items-center group-hover:scale-105 transition-transform duration-200">
                  {user.sub ? (
                    <div className="flex items-center bg-gradient-to-r from-teal-50 to-teal-100 px-4 py-3 rounded-xl border border-teal-200">
                      <svg
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  ...
                  <p className="text-base text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">
                    {formatDate(user.iat)}
                  </p>
                </div>
              ...
              <div className="group">
                ...
                <div className="flex items-center space-x-3 mt-3">
                  <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-gradient-to-r from-teal-400 to-teal-500 text-white shadow-lg">
                    <svg
          ...
          <div className="px-8 py-6">
            <div className="space-y-4">
              ...
              <div
                ...
                className="group bg-gradient-to-r from-teal-50 to-teal-100/50 hover:from-teal-100 hover:to-teal-200/50 border border-teal-200/50 hover:border-teal-300 rounded-xl p-6 cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-r from-teal-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                      <svg
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 group-hover:text-teal-600 transition-colors duration-200">
                        Explore our curated collection of artisan crafts
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 group-hover:text-gray-600 transition-colors duration-200">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-red-700 transition-colors duration-200">
                        Logout
                      </h3>
                      <p className="text-sm text-gray-600 group-hover:text-red-600 transition-colors duration-200">
