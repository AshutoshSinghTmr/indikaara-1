  ...
  return (
    <main className="min-w-auto bg-background text-primary mt-10 pt-24 pb-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        {/* Terms Content */}
        <div className="min-w-auto prose-invert max-w-none">
          <div className="bg-gray-800/50 rounded-xl p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                Welcome to Indikaara. These Terms of Service ("Terms") govern
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-text-secondary space-y-2">
                <li>
                  <strong>"Company"</strong> refers to Indikaara Handicrafts Pvt
                  Ltd
                </li>
                <li>
                  <strong>"Service"</strong> refers to our website, products,
                ...
                <li>
                  <strong>"Products"</strong> refers to handcrafted items sold
                  through our platform
                </li>
                <li>
                  <strong>"Content"</strong> refers to text, images, videos, and
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                By creating an account, making a purchase, or using our
                services, you acknowledge that you have read, understood, and
                agree to be bound by these Terms and our Privacy Policy. These
                Terms apply to all visitors, users, and customers of our
                Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                ...
                pricing. However, due to the handcrafted nature of our products,
                slight variations in color, size, and design may occur. We
                reserve the right to correct any errors in product information
                or pricing.
              </p>
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                ...
                products. We reserve the right to accept or decline any order.
                Payment must be received before order processing begins. All
              ...
              <p className="text-text-secondary leading-relaxed">
                Orders may be modified or cancelled within 2 hours of placement.
                After this period, orders enter production and cannot be
                modified. Custom orders cannot be cancelled once production
                begins.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                We offer shipping within India and internationally. Delivery
                times are estimates and may vary due to:
              </p>
              ...
              <p className="text-text-secondary leading-relaxed">
                Risk of loss and title pass to you upon delivery to the shipping
                carrier. We are not responsible for delays or damages during
                shipping.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-text-secondary space-y-2 mb-4">
                <li>
                  30-day return window for most items in original condition
                </li>
                <li>
                  Custom or personalized items are non-returnable unless
                  defective
                </li>
                <li>
                  Return shipping costs are the responsibility of the customer
                  unless items are defective
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed mb-4">
                ...
                functionality are owned by Indikaara and are protected by
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-text-secondary space-y-2">
                ...
                <li>
                  To transmit harmful code, viruses, or malicious software
                </li>
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                To the fullest extent permitted by law, Indikaara shall not be
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                You agree to defend, indemnify, and hold harmless Indikaara and
                its affiliates from any claims, damages, obligations, losses,
                liabilities, costs, or fees arising from your use of the Service
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                ...
                notify users of significant changes by email or through
                prominent notices on our website. Your continued use of the
            ...
            <section>
              ...
              <div className="bg-gray-700/50 rounded-lg p-6">
                ...
                <p className="text-text-secondary">Email: info@indikaara.com</p>
